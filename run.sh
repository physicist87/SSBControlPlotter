...
STUDYNAME="NanoAOD_v3" 
#STUDYNAME="NanoAOD_v2" 
...
INPUT_LIST="input/NanoAOD_v2/UL2017/MuMu/NanoAOD_v2_UL2017_MuMu.list"
INPUT_LIST="input/NanoAOD_v3/UL2018/MuMu/NanoAOD_v3_UL2018_MuMu.list"
INPUT_LIST="input/${STUDYNAME}/UL2018/MuMu/${STUDYNAME}_UL2018_MuMu.list"
...
OUTPUT_DIR="ExtendABCD_v1/UL2018/MuMu"
OUTPUT_DIR="NanoAOD_v2/UL2018/MuMu"
OUTPUT_DIR="NanoAOD_v2/UL2017/MuMu"
OUTPUT_DIR="NanoAOD_v3/UL2018/MuMu"
OUTPUT_DIR="${STUDYNAME}/UL2018/MuMu"
...
#LUMI_TEXT="47.48 fb^{-1} (13 TeV)" # Add luminosity text 2017
